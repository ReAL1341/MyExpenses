...
public class User {
	...
	/**
	 * バリデーションなしでカテゴリーを追加する。
	 * 初期カテゴリーの追加やRepositoryでの再構成に使用する。
	 */
	public void add(String categoryName) {
		Category category = new Category(categoryName, this.colorStock.pop());
	 ...
	 * カテゴリーの個数制限を超過した場合
	 */
	public void addNewCategory(String categoryName) throws DomainException {
